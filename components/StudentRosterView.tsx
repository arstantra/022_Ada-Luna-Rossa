            ...
            <div className="flex-1 overflow-y-auto p-6">
                <div className="max-w-4xl mx-auto">
                    <p className="text-gray-400 mb-4">
                        Seleziona uno studente per accedere alla sua scheda personale e visualizzare il suo Diario di Bordo.
                    </p>
                    {students.length > 0 ? (
                        ...
                        <div className="text-center py-12 px-4 bg-gray-900/50 rounded-lg">
                            <p className="text-gray-300 font-semibold">Nessuno studente trovato</p>
                            <p className="text-gray-400 text-sm mt-1">
                                Vai su "L'Equipaggio" per aggiungere gli studenti della classe.
                            </p>
                        </div>
                    )}
                </div>
