...
const getOrCreateConversationForWeek = useCallback((weekInfo: WeekRouteInfo): Conversation => {
  ...
  // --- Handler factories ---
  const {
    handleSetWeekTheme, handleUpdateWeekTheme, handleUpdateBlockObjective, handleUpdateBlockTitle,
